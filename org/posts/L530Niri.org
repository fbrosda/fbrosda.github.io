...
#+begin_src sh
sudo pacman -Syu alacritty brightnessctl diff-so-fancy emacs-wayland firefox fuzzel gnome-keyring gvfs hostname htop hunspell hunspell-de hunspell-en_us inetutils isync ly mako msmtp niri openssh pass pcmanfm-gtk3 ripgrep seahorse stow swaybg swayidle swaylock waybar wev wlsunset xdg-desktop-portal-gtk xdg-user-dirs xwayland-satellite
#+end_src
...
In Emacs funktioniert aktuell nur das Lesen, aber nicht das Schreiben von Passwörtern mittels easy-pgp. Warum?
